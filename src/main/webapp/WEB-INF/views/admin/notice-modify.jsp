    ...
    <div class="container-fluid">
        ...
        <div id="sideNav" class="col-12 col-sm-2">
            ...
            <div class="col-12 col-sm-10">
                ...
                <input type="hidden" name="notice_id" value="${noticeModify.notice_id}">
	    		<div>
			    	...
			    	<div>
				    	<textarea name="notice_content" id="Notice_content" placeholder="내용을 입력하세요." style="resize: none;">
				    		${noticeModify.notice_content}
				    	</textarea>
			    	</div>
		    	</div>    		
