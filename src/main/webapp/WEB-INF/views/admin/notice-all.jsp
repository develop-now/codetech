			        ...
			        <ul class="pagination justify-content-center">
			            ...
			            <c:if test="${page > 1}">
			                  <li class="page-item"><a
			                     href="noticeAll?page=${page-1}&search_word=${search_text}&notice_status=${notice.notice_status}"
			            ...
			            <c:forEach var="a" begin="${startpage}" end="${endpage}">
			                  ...
			                  <c:if test="${a != page }">
			                     <li class="page-item"><a
			                        href="noticeAll?page=${a}&search_word=${search_text}&notice_status=${notice.notice_status}"
			                        class="page-link">${a}</a>
			                     </li>
			                  </c:if>
			            </c:forEach>
			            ...
			            <c:if test="${page < maxpage }">
			                  <li class="page-item"><a
			                     href="noticeAll?page=${page+1}&search_word=${search_text}&check_state=${check_state}"
