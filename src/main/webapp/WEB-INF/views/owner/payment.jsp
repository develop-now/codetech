...
<body>
	<form
		action="${pageContext.request.contextPath}/owner/payment_complete"
		method="get" id="test">
		<input type="hidden" class="cartCount" name="cartCount"
			value="${cartCount }"> <input type="hidden" class="amount"
			name="amount" value="${amount }"> <input type="hidden"
			class="price" name="price" value="${newtotalPrice }"> <input
			type="hidden" class="email" value="${user.user_email }"> <input
			type="hidden" class="name" value="${user.user_name }"> <input
			type="hidden" class="tel" value="${user.user_tel }"> <input
			type="hidden" class="user_id" name="user_id" value="${user_id}">
