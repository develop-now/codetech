	...
	<div id="frame">
		<div class="content">
			<div class="contact-profile">
				<img src="resources/upload${store.store_saved_image}" alt="나의 아바타" />
			...
			<div class="message-input">
				<div class="wrap">
					<input type="text" id="write" placeholder="Write our message..." />
	...
	<script>
		...
		$('.exit').click(function() {
			if (confirm("정말로 나가시겠습니까?")) {
				send("${store.store_name}님이 퇴장하셨습니다.out")
				ws.close();
			}
		});
		...
		ws.onmessage = function(event) {
			...
			//java&/2019-7-4/bbs20303030.png&님이 퇴장하셨습니다. out)
			response(event.data);
		};
		...
		//text의 전달 형식 - java&/2019-7-4/bbs20303030.png&님이 퇴장하셨습니다. out
		arr = text.split('&')
		message = arr[2];
