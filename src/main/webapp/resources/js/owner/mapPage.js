$(function() {
	...
	// 마커가 많으면 성능 문제 이슈가 있음. n백개 수준으로 증가하게 되면 properties 파일에 마커정보를 담고 해당 js를
	// jsp로 이동해서 불러와야 함.
	var positions = [ {
		...
		content : '<div>우유커피<br><a href="http://localhost:8088/www/user/orderMain?store_id=9" style="color:blue" target="_blank">주문하러가기</a></div>',
